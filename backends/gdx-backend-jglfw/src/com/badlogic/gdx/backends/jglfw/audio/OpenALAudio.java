...
public class OpenALAudio implements Audio {
	...
	public OpenALSound newSound (FileHandle file) {
		...
		try {
			return (OpenALSound) soundClass.getConstructor(new Class[] {OpenALAudio.class, FileHandle.class}).newInstance(this, file);
		} catch (Exception ex) {
	...
	public OpenALMusic newMusic (FileHandle file) {
		...
		try {
			return (OpenALMusic) musicClass.getConstructor(new Class[] {OpenALAudio.class, FileHandle.class}).newInstance(this, file);
		} catch (Exception ex) {
